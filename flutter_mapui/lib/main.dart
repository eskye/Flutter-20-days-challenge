      ...
      body: Stack(
        children: <Widget>[
          Container(
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                           ...
                           makeItem(image: 'assets/images/place-1.jpg'),
                           makeItem(image: 'assets/images/place-2.jpg'),
                           makeItem(image: 'assets/images/place-3.jpg')
                        ],
                      ),
                    ),
                    SizedBox(height: 30,)
           ...
           makePoint(top: 100.0, left: 300.0),
        ],
      ),
    );
  }
      ...
      child: Container(
        ...
        child: Animator<double>(
          ...
          builder: (context, state, child) => Center(
            child: Container(
              margin: EdgeInsets.all(state.value),
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: Colors.blue
              ),
